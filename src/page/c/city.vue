  ...
  <div>
    ...
    <el-dialog :label-position="labelPosition" width="55%" title="城市" :visible.sync="dialogForm">
      <el-form ref="putform" :model="putform" label-width="100px" size="mini">
        <el-form-item label="名称">
          <el-input size="mini" clearable v-model="putform.name" placeholder="请输入"></el-input>
        </el-form-item>

        <el-form-item label="日期">
          <el-date-picker clearable v-model="putform.day" type="datetime" placeholder="选择日期时间"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="文件" v-if="!putform.sel">
          <el-upload
            class="upload-demo"
            :headers="headers"
        ...
        <el-form-item label="文本">
          <div>
            ...
            <el-row v-loading="quillUpdateImg">
              <quill-editor v-model="putform.texts" ref="myQuillEditor" :options="editorOption"></quill-editor>
            </el-row>
          </div>
        </el-form-item>
      </el-form>
